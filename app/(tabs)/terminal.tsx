  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Ionicons name="terminal-outline" size={24} color="#00f0ff" />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.menuList}>
            ...
            <View style={styles.menuItem}>
                ...
                <Ionicons name="bluetooth-outline" size={20} color="#00f0ff" />
            </View>
            <View style={styles.menuItem}>
                <Text style={styles.menuText}>SESSION LOGS</Text>
                <Ionicons name="document-text-outline" size={20} color="#00f0ff" />
            </View>
            <View style={styles.menuItem}>
                <Text style={styles.menuText}>STEALTH MODE</Text>
                <Ionicons name="eye-off-outline" size={20} color="#00f0ff" />
            </View>
        </View>
